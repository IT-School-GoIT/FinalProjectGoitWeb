...
def save_currencies_to_database(currencies_list):
    currencies_objects = [Currencies(bank_name=currencies['bank_name'], buy_eur=currencies['eur_buy'], sell_eur=currencies['eur_sell'], buy_usd=currencies['usd_buy'], sell_usd=currencies['usd_sell'], pln_buy=currencies['pln_buy'], pln_sell=currencies['pln_sell'], url_link=currencies['url_link']) for currencies in currencies_list]
...
def privat_currency(url='https://privatbank.ua'):
    ...
    return [{'bank_name': "PrivatBank", 'eur_buy': eur_buy, 'eur_sell': eur_sell, 'usd_buy': usd_buy, 'usd_sell': usd_sell, 'pln_buy': pln_buy, 'pln_sell': pln_sell, 'url_link': 'https://privatbank.ua'}]
...
def pumb_currency(url='https://about.pumb.ua/info/currency_converter'):
    ...
    return [{'bank_name': "Pumb", 'eur_buy': eur_buy, 'eur_sell': eur_sell, 'usd_buy': usd_buy, 'usd_sell': usd_sell, 'pln_buy': pln_buy, 'pln_sell': pln_sell, 'url_link': 'https://about.pumb.ua/info/currency_converter'}]
...
def minfin_currency(url='https://minfin.com.ua/currency/'):
    ...
    usd_buy = soup.select_one('td.sc-1x32wa2-6.bIIiwq').find_next_sibling('td').div.text.strip()[:5]
    usd_sell = soup.select_one('td.sc-1x32wa2-6.bIIiwq').find_next_sibling('td').find_next_sibling(
        'td').div.text.strip()[:5]
    ...
    return [{'bank_name': "Minfin", 'eur_buy': eur_buy, 'eur_sell': eur_sell, 'usd_buy': usd_buy, 'usd_sell': usd_sell, 'pln_buy': pln_buy, 'pln_sell': pln_sell, 'url_link': 'https://minfin.com.ua/currency/'}]
...
def finance_currency(url='https://finance.ua/ru/currency'):
    ...
    return [{'bank_name': "Finance.ua", 'eur_buy': eur_buy, 'eur_sell': eur_sell, 'usd_buy': usd_buy, 'usd_sell': usd_sell, 'pln_buy': pln_buy, 'pln_sell': pln_sell, 'url_link': 'https://finance.ua/ru/currency'}]
